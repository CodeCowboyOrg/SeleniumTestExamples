...
namespace SeleniumRemoteControlMsTest
{
    ...
    /// </summary>
    [CodedUITest]
    public class SeleniumMsTestLiveAccountLogin2
    {
        ...
        //Constructor
        public SeleniumMsTestLiveAccountLogin2()
        {
        ...
        public void TestLiveLogin2()
        {
            ...
            selenium.CaptureScreenshot(@"C:\Temp\Screenshot-001.png");
            selenium.Click("id=idSIButton9");
            selenium.WaitForPageToLoad("30000");
            Thread.Sleep(4000);
            selenium.CaptureScreenshot(@"C:\Temp\Screenshot-002.png");
            selenium.Click("id=c_meun");
            Thread.Sleep(1000);
            selenium.Click("id=c_signout");
            selenium.WaitForPageToLoad("30000");
            Thread.Sleep(4000);
            selenium.CaptureScreenshot(@"C:\Temp\Screenshot-003.png");
            Thread.Sleep(2000);
        }
